...
const Collection = (
  ...
  return (
    <>
        {data.length > 0 ? (
            <div className='flex flex-cols items-center gap-10'>
            ...
            <div className='flex-center wrapper min-h-[200px] w-full flex-col gap-3 rounded-[14px] bg-black-50 py-28 text-center'>
